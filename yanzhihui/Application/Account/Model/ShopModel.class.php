...
class ShopModel extends CommonModel {
    ...
    /* 新增和编辑数据的时候允许写入字段 */
    protected $insertFields = 'title,longitude,latitude,province,city,area,address,telephone,per_capita,upfile,upfile_list';
    protected $updateFields = 'id,title,longitude,latitude,province,city,area,address,telephone,per_capita,upfile,upfile_list';
