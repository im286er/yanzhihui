...
class UserModel extends CommonModel {
    ...
    /* 插入模型数据 操作状态 */
    const MODEL_LOGIN = 5; //注册用户
    const MODEL_LOGIN_OTHER = 6; //手机用户登录
    const MODEL_EDIT_INFO = 7; //第三方平台用户登录
    const MODEL_EDIT_PASSWORD = 8; //修改资料
    const MODEL_RESET_PASSWORD = 9; //修改密码
    const MODEL_RESET_AUTH_UPFILE_HEAD = 10; //重置密码
    protected $_map = array(); //认证头像
