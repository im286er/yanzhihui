...
class ShopCouponModel extends CommonModel {
    ...
    protected $_auto = array(
        ...
        array('shop_account_id', 'auto_shop_account_id', self::MODEL_INSERT, 'callback'),
    ...
    /* 获取 shop_account_id */
    protected function auto_shop_account_id(){
        $shop_id = I('post.shop_id');
        $where['id'] = array('EQ', $shop_id);
        $shop_account_id = M('Shop')->where($where)->getField('shop_account_id');
